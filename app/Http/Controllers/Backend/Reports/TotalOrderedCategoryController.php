...
use PDF;
class TotalOrderedCategoryController extends Controller
{
    ...
    public function exportOrderCategoryExcel(Request $request){
        ...
        if ($request == 'category_name_asc') {
            $sort = 'Category Name (A-Z)';
            $column_name = 'name';
            $order_name = 'asc';
        } elseif ($request == 'category_name_desc') {
            $sort = 'Category Name (Z-A)';
            $column_name = 'name';
            $order_name = 'desc';
        } elseif ($request == 'order_quantity_asc') {
            $sort = 'Order Quantity (Low-High)';
            $column_name = 'order_quantity';
            $order_name = 'asc';
        } elseif ($request == 'order_quantity_desc') {
