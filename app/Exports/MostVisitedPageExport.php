...
class MostVisitedPageExport implements FromCollection, WithHeadings, ShouldAutoSize, WithMapping,  WithStyles, WithEvents, WithDrawings
{
    protected $startdate;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                // dd($this->sort);
                $event->sheet->setCellValue('A2','Most Visited Page Report');
                ...
                $event->sheet->setCellValue('A18','Prepared by: ' . $this->user_name);
                $event->sheet->setCellValue('A19', date('F d, Y h:i:s', strtotime(Carbon::now())));
