...
class ProductByCustomerExport implements FromCollection,ShouldAutoSize,WithHeadings,WithMapping,WithStyles, WithEvents, WithColumnWidths, WithDrawings
{
    /**
    ...
    */
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                // dd($this->sort);
                $event->sheet->setCellValue('A2', $this->product_name . ' Orders Report');
    ...
    public function __construct($sorting, $startdate,$enddate, $product_name, $product_id){
