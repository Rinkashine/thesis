...
class CustomerSpentExport implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithStyles, WithEvents, WithColumnWidths, WithDrawings
{
    protected $sorting;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                // dd($this->sort);
                $event->sheet->setCellValue('A2','Customer Total Spent Report');
    ...
    public function __construct($sorting, $startdate, $enddate)
    {
        ...
        if ($this->sorting == 'customer_name_asc') {
            ...
            $this->sort = 'Customer Total Spent (Low-High)';
            $this->column_name = 'total_spent';
            $this->order_name = 'asc';
        } elseif ($this->sorting == 'total_spent_desc') {
            $this->sort = 'Customer Total Spent (High-Low)';
            $this->column_name = 'total_spent';
            $this->order_name = 'desc';
        } else {
            $this->column_name = 'name';
    ...
    public function headings(): array
    {
        return [
            ...
            [],
            [],
            ['Customer Name','Customer Email', 'Total Spent',]
        ];
    }
}
