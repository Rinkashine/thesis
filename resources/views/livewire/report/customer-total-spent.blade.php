<div class="intro-y box p-5">
    <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
        <div class="font-medium text-base flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5">
            <a href="{{Route('report.index')}}" class="mr-2 btn">←</a> Customer Total Spent
        </div>
        <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
            ...
            @can('report_export')
                <div class="mt-5">
                    <a href="{{Route('exportCustomerTotalSpent',['sorting'=>$sorting,'startdate'=>$from,'enddate'=>$to])}}" class="btn btn-primary"> <i class="fa-solid fa-file-excel mr-1"></i> Export Excel </a>
                </div>
            @endcan
        </div>
