            ...
            <div class="xl:flex sm:mr-auto mt-5" >
                ...
                <div class="sm:flex items-center sm:mr-4">
                    ...
                    <select wire:model="sorting"  class="form-select w-32 mt-2 sm:mt-0 sm:w-auto">
                        <option value="ordered_products.product_name">Product Name</option>
                    ...
                    <div class="dropdown w-1/2 sm:w-auto">
                        ...
                        <div class="dropdown-menu w-40">
                            <ul class="dropdown-content">
                                <li>
                                    <a href="{{Route('exportSalesProductEXCEL',['startdate'=>$from,'enddate'=>$to])}}" class="dropdown-item"> <i class="fa-solid fa-file-excel mr-1"></i> Export Excel </a>
                                </li>
                                <li>
                                    <a  href="{{Route('exportSalesProductCSV',['startdate'=>$from,'enddate'=>$to])}}" class="dropdown-item"> <i class="fa-solid fa-file-csv mr-1"></i>  Export CSV </a>
                                </li>
                            </ul>
                        </div>
                    </div>
