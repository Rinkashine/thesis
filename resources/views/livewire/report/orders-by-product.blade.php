    ...
    <div class="intro-y box p-5">
        <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5">
            <div class="font-medium text-base flex items-center border-b border-slate-200/60 dark:border-darkmode-400 pb-5">
                <a href="{{Route('report.index')}}" class="mr-2 btn">←</a> Quantity of Orders by Product
            </div>
                            ...
                            <tbody>
                                @foreach ($products as $product )
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap text-center">{{ number_format($product->order_quantity)}}</td>
                                        <td class="whitespace-nowrap text-center"><a href="{{ Route('report.ProductByCustomer',['name' => $product->name, 'id' => $product->id]) }}">View Details</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
