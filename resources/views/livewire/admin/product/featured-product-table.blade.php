<div>
    <div class="flex justify-between intro-y mt-10 sm:justify-center">
        <div>
            <h2 class=" text-lg font-medium ">List Featured Products</h2>
        </div>
    </div>
            ...
            <div class="xl:flex sm:mr-auto" >
                <div class="sm:flex items-center sm:mr-4">
                    ...
                    <select wire:model="sorting"  class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                        ...
                        <option value="updatedatnew">Updated (newest first)</option>
                   ...
                   @foreach($products as $product)
                       <tr class="intro-x">
                           <td class="whitespace-nowrap font-medium">
                            <a href="{{ Route('product.edit', $product) }}" target="_blank">
                           ...
                           <td class="table-report__action w-56">
                               <div class="flex justify-center items-center">
                                   <div class="flex justify-center items-center">
                                        @can('product_archive')
                                            <button wire:click="RemoveToFeatured({{$product->id}})" class="flex items-center text-danger ">
